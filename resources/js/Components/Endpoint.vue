...
const deleteEndpoint = () => {
    if (window.confirm("Estás seguro de eliminar el endpoint")) {
    ...
    <tr>
            ...
            <template v-if="editing">
                ...
                >
                    <option
                        ...
                        v-for="frequency in page.props.value.endpointFrequencies
                            .data"
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
            <template v-if="endpoint.latest_check">
                <time
                    :datetime="endpoint.latest_check.created_at.date_time"
                    :title="endpoint.latest_check.created_at.human"
                >
        ...
        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">x%</td>
        <td
